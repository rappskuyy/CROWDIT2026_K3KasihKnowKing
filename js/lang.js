...
const TRANSLATIONS = {
  en: {
    ...
    hydStudy1:          'Studies show adequate hydration helps maintain focus during class.',
    hydStudy2:          'Drinking water before meals can improve cognitive function.',
    hydLearnDesc:       'Learn why hydration is essential for student performance.',
    hydLearnDescShort:  'Quick hydration facts for better learning.',
    peHydration:        'PE & Hydration',
    peHydDesc:          'Stay hydrated during physical education classes.',
    peHydDescShort:     'Quick hydration tips for PE.',
    peHydDetail:        'View Details',
    recessHydration:    'Recess Hydration',
    waterCognitive:     'Water & Cognitive Performance',
  ...
  id: {
    ...
    hydStudy1:          'Studi menunjukkan hidrasi yang cukup menjaga fokus selama kelas.',
    hydStudy2:          'Minum air sebelum makan meningkatkan fungsi kognitif.',
    hydLearnDesc:       'Pelajari mengapa hidrasi penting untuk performa siswa.',
    hydLearnDescShort:  'Fakta hidrasi cepat untuk belajar lebih baik.',
    peHydration:        'Olahraga & Hidrasi',
    peHydDesc:          'Tetap terhidrasi selama pelajaran olahraga.',
    peHydDescShort:     'Tips hidrasi cepat untuk olahraga.',
    peHydDetail:        'Lihat Detail',
    recessHydration:    'Hidrasi Saat Istirahat',
    waterCognitive:     'Air & Performa Kognitif',
